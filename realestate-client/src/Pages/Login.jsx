...
function Login() {
  ...
  return (
    ...
    <div className="lg:flex w-1/2 hidden bg-white bg-no-repeat bg-cover relative items-center" style={{backgroundImage: `url('https://images.unsplash.com/photo-1540387517454-e881631cf830?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')`}}>
          ...
          <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style={{backgroundColor: 'white'}}>
              ...
              <div class="w-full py-6 z-20">
                  <h1 class="mx-auto">
                      <div class="min-w-max w-1/2 inline-flex relative">
                          <a href="/" class="relative flex items-center gap-3">
                              <div class="relative w-7 h-7 overflow-hidden flex rounded-xl">
                                  ...
                                  <span class="absolute w-2 h-2 rounded-full bg-gray-900 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"></span>
                              </div>
                              <div class="inline-flex text-3xl font-semibold text-gray-900">
                                  AgenceX
                              </div>
                          </a>
                      </div>
                  </h1>
                  <div class="py-6 space-x-2 text-black">
