...
function Edit(props) {
    ...
    const UpdateFacilty= async (e)=>{
        ...
        try{
            ...
            await axios.patch(`https://localhost:7108/Update/${agent._Id}/${propData._id}`,formData,{
                headers: {
          ...
          // Access the propData from props.location.state
...
<form className='mt-12 mx-4 bg-gray-100  '>
   <div class="grid gap-6 mb-6 md:grid-cols-2">
       <div>
           ...
           <input  onChange={(e)=>setFacilityName(e.target.value)}  type="text" id="FacilityName" class="bg-gray-50 border border-blue-700 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  " placeholder={propData.facilityName}  />
       </div>
       <div>
           <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">Price</label>
           <input  onChange={(e)=>setPrice(e.target.value)}  type="number" id="Price" class="bg-gray-50 border border-blue-700 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  " placeholder={propData.price}  />
       </div>
       <div className=''>
 ...
 <select onChange={(e)=>setPropertyType(e.target.value)} id="default" class="bg-gray-50 border border-blue-700 text-gray-900  text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
   ...
   <option value="Studio">Studio</option>
       ...
       <input onChange={(e)=>setRooms(e.target.value)}  type="Number" id="rooms" class="bg-gray-50 border border-blue-700 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  " placeholder={propData.rooms}  />
       </div>
       <div>
           <label for="city" class="block mb-2 text-sm font-medium text-gray-900 ">City</label>
           <input type="text"onChange={(e)=>setCity(e.target.value)} id="city" class="bg-gray-50 border border-blue-700 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  " placeholder={propData.city}  />
       </div>
       <div class="">
   <label for="location" class="block mb-2 text-sm font-medium text-gray-900 ">Google Maps Adress</label>
           <input type="text"  onChange={(e)=>setLocation(e.target.value)}  id="website" class="bg-gray-50 border border-blue-700 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  " placeholder={propData.location}  />
   ...
   <div class="">
     ...
     <textarea id="Description" onChange={(e)=>setDescription(e.target.value)} rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-blue-700 focus:ring-blue-500 focus:border-blue-500  " placeholder={propData.description}></textarea>
...
<div class="flex items-center justify-center w-full">
   ...
   <button type='submit' onClick={UpdateFacilty} class="flex items-center justify-between w-full px-6 py-3 text-sm tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-md hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                       <span>Submit </span>
