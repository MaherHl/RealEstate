    ...
    <div ClassName=''>
        ...
        <div ClassName=''>
            <div className='mt-20 flex items-center justify-center'>
                <div className='mx-6'>
                     <img class="w-36 h-36 rounded-full" src={pic} alt="Rounded avatar"/> 
            ...
            <div className='flex  px-2 text-lg pt-2 text-gray-400 '>
                <div className='py-1 mx-2'>
                <FaPhone/>
                </div>
                
              <p ClassName=" "> +212 666 666 666</p>
        
            </div>
            <div className='flex text-lg px-2 text-gray-400 '>
                <div className='py-1 mx-2'>
                <MdLocationPin/>
                </div>
            ...
            <div class="flex justify-center py-3 ">
                ...
                <div class="mr-4 p-3 text-center">
                  <span class="text-2xl font-bold block uppercase tracking-wide text-sky-600">22</span><span class="text-xl font-bold text-gray-600 ">Desks</span>
                </div>
                <div class="mr-4 p-3 text-center">
                  <span class="text-2xl font-bold block uppercase tracking-wide text-sky-600">10</span><span class="text-xl  font-bold text-gray-600">Appartements</span>
                </div>
                <div class="lg:mr-4 p-3 text-center">
                  <span class="text-2xl font-bold block uppercase tracking-wide text-sky-600">89</span><span class="text-xl font-bold text-gray-600">Studios</span>
                </div>
              </div>
              
              <div class="mt-10  pt-5 pb-10 border-t border-b border-blueGray-200 text-center">
                <div>
                <h3 class="text-2xl pb-4 leading-tight 
            font-bold text-gray-900">
                About  <span class="text-transparent bg-clip-text bg-gradient-to-br from-indigo-600 from-20% via-blue-600 via-30% to-green-600"> Me</span>
...
<div class="grid grid-cols-1 p-8 sm:grid-cols-2 bg-gray-100 lg:grid-cols-3 xl:grid-cols-4 gap-6 w-full">
